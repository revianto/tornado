        ...
        <div class="container-xxl flex-grow-1 container-p-y">
          ...
          <div class="row">
            ...
            <div class="card pb-3 px-5">
                <h5 class="card-header fw-bold px-1 pt-5 pb-3">Detail Pembelian</h5>
                <table class="table table-striped table-row-bordered table-rounded table-striped table-hover border gy-5 gs-7">
                    <tr>
                        <td class="fw-bold text-end" style="width: 340px; height: 55px !important;">Nama Barang :</td>
                        <td ><?php echo $nama_barang; ?></td>
                    </tr>
                    <tr>
                        <td class="fw-bold text-end" style="width: 340px; height: 55px !important;">Tanggal Pembelian :</td>
                ...
                <center class="py-4">
                    <a href="<?= site_url('Pembelian') ?>" class="btn btn-outline-danger">
